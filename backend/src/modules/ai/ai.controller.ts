...
export async function askQuestion(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to process question'); }
}
...
export async function getChatHistory(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to get chat history'); }
}
...
export async function deleteSession(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to delete session'); }
}
...
export async function clearHistory(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to clear history'); }
}
...
export async function renameSession(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to rename session'); }
}
...
export async function addBookmark(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to bookmark message'); }
}
...
export async function removeBookmark(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to remove bookmark'); }
}
...
export async function getBookmarks(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to get bookmarks'); }
}
...
export async function getDailyVerse(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to get daily verse'); }
}
