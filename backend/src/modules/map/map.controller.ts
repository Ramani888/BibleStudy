...
export async function updateLocation(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to update location'); }
}
...
export async function getFriendsLocations(req: Request, res: Response): Promise<void> {
  ...
  } catch (error) { handleControllerError(res, error, 'Failed to get friends locations'); }
}
...
export async function updatePrivacy(req: Request, res: Response): Promise<void> {
  try {
    ...
    sendSuccess(res, result, result.message);
  } catch (error) { handleControllerError(res, error, 'Failed to update privacy'); }
}
