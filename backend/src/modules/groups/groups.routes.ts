...
import { CreateGroupDto, UpdateGroupDto, UpdateRoleDto, AddMemberDto } from './groups.dto';
...
router.post('/:id/join',                 groupsController.joinPublicGroup);
router.post('/:id/members',              validate(AddMemberDto), groupsController.addMember);
