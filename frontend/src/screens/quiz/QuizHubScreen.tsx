...
import { ChevronRightIcon, HelpCircleIcon, StarIcon, StarOutlineIcon } from '../../components/icons';
    ...
    return (
      ...
      >
        <View style={styles.rowIcon}>
          <HelpCircleIcon size={22} color={quizzable ? colors.primary : colors.textDisabled} />
        </View>
        ...
        {quizzable && <ChevronRightIcon size={18} color={colors.textDisabled} />}
      </Pressable>
    );
  };
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        <Typography preset="h2" color={colors.textPrimary}>Quiz</Typography>
