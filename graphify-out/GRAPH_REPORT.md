# Graph Report - BibleStudy  (2026-04-30)

## Corpus Check
- 211 files · ~59,365 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 609 nodes · 655 edges · 15 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 243 edges (avg confidence: 0.8)
...
5. `register()` - 5 edges
6. `verifyEmail()` - 5 edges
7. `verifySetOwnership()` - 5 edges
...
Cohesion: 0.1
Nodes (16): bulkCreateCards(), calculateNextReviewAt(), copyCard(), createCard(), listCardsBySet(), moveCard(), recordStudyResult(), updateCard() (+8 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (9): createFolder(), updateFolder(), useCreateSet(), CreateSetScreen(), handleAssignFolder(), handleCreateFolder(), handleEditFolder(), createSet() (+1 more)
...
Cohesion: 0.14
Nodes (7): useFolders(), useDeleteSet(), useSet(), useSets(), useUpdateSet(), EditSetScreen(), FolderDetailScreen()
...
Cohesion: 0.13
Nodes (5): AIChatScreen(), DailyLoginButton(), useAIChat(), useClaimDailyLogin(), useCreditBalance()
...
- **Why does `getErrorMessage()` connect `Community 5` to `Community 2`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `logActivity()` connect `Community 1` to `Community 2`, `Community 3`?**
...
- **Are the 4 inferred relationships involving `register()` (e.g. with `generateOTP()` and `storeOTP()`) actually correct?**
